...
/***/ function(module, exports, __webpack_require__) {
	...
	var timekeeper = __webpack_require__(11);
	var RangePicker = __webpack_require__(3);

	var Header = __webpack_require__(4);
	var Footer = __webpack_require__(5);
	var GithubRibbon = __webpack_require__(6);
	var CodeSnippet = __webpack_require__(7);
	var Install = __webpack_require__(8);
	...
	var DatePickerRange = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(RangePicker, _extends({}, this.props, { onSelect: this.handleSelect, value: this.state.value })),
	      React.createElement(
	        'div',
	        null,
	...
	var DatePickerSingle = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(RangePicker, _extends({}, this.props, { onSelect: this.handleSelect,
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('link', { href: 'css/react-calendar.css', rel: 'stylesheet' }),
	        React.createElement('link', { href: 'css/example.css', rel: 'stylesheet' }),
	        React.createElement('meta', { name: 'viewport', content: 'width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1' }),
	        React.createElement('script', { src: 'https://cdn.polyfill.io/v1/polyfill.min.js' })
	      ),
	      React.createElement(
	        'body',
	        null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BemMixin = __webpack_require__(13);
	...
	var _CalendarDate = __webpack_require__(16);

	var _CalendarDate2 = _interopRequireDefault(_CalendarDate);

	var _PaginationArrow = __webpack_require__(17);
	...
	var DateRangePicker = _React2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _React2['default'].createElement('div', { className: this.cx({ element: null }) }, _React2['default'].createElement(PaginationArrow, { direction: 'previous', onMouseEnter: this.moveBackIfSelecting, onClick: this.moveBack, disabled: !this.canMoveBack() }), calendars.toJS(), _React2['default'].createElement(PaginationArrow, { direction: 'next', onMouseEnter: this.moveForwardIfSelecting, onClick: this.moveForward, disabled: !this.canMoveForward() }), showLegend ? _React2['default'].createElement(_Legend2['default'], { stateDefinitions: stateDefinitions, selectedLabel: selectedLabel }) : null);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          "a",
	          { href: "http://tech.onefinestay.com/", className: "footer__link" },
	          "Blog"
	        ),
	        React.createElement(
	          "a",
	          { href: "https://github.com/onefinestay", className: "footer__link" },
	          "Github"
	        ),
	        React.createElement(
	          "a",
	          { href: "https://twitter.com/buildingOFS", className: "footer__link" },
	          "Twitter"
	        )
	      )
	    );
	...
	var OFSCredit = React.createClass({
	  displayName: "OFSCredit",

	  render: function render() {
	    return React.createElement(
	      "div",
	      { className: "ofs-credit" },
	      React.createElement(
	        "p",
	        { className: "ofs-credit__text" },
	        "Built by"
	      ),
	      React.createElement(
	        "a",
	        { href: "http://www.onefinestay.com/", className: "ofs-credit__logo" },
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      this.props.toggle ? React.createElement(
	        'a',
	        { href: '#', onClick: this.handleClick, className: 'code-snippet__toggle-button' },
	      ...
	      this.state.visible ? React.createElement(
	        ...
	        React.createElement(
	          'code',
	          { className: this.props.language, ref: 'codeBlock' },
	          this.props.children
	        )
	      ) : null
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroup = __webpack_require__(29);
	var ReactTransitionGroup = __webpack_require__(30);
	...
	if ("production" !== process.env.NODE_ENV) {
	  React.addons.Perf = __webpack_require__(35);
	  React.addons.TestUtils = __webpack_require__(36);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bemCx = __webpack_require__(20);
	  ...
	  render: function render() {
	    ...
	    for (name in stateDefinitions) {
	      ...
	      if (def.label && def.color) {
	        ...
	        items.push(_React2['default'].createElement('li', { className: this.cx({ element: 'LegendItem' }), key: name }, _React2['default'].createElement('span', { className: this.cx({ element: 'LegendItemColor' }), style: style }), _React2['default'].createElement('span', { className: this.cx({ element: 'LegendItemLabel' }) }, def.label)));
	      }
	    }

	    return _React2['default'].createElement('ul', { className: this.cx() }, _React2['default'].createElement('li', { className: this.cx({ element: 'LegendItem' }) }, _React2['default'].createElement('span', { className: this.cx({ element: 'LegendItemColor', modifiers: { selection: true } }) }), _React2['default'].createElement('span', { className: this.cx({ element: 'LegendItemLabel' }) }, selectedLabel)), items);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CalendarMonth = _React2['default'].createClass({
	  ...
	  renderWeek: function renderWeek(dates, i) {
	    ...
	    return _React2['default'].createElement('tr', { className: this.cx({ element: 'Week' }), key: i }, days.toJS());
	  },
	  ...
	  renderDayHeaders: function renderDayHeaders() {
	    ...
	    var headers = indices.map((function (index) {
	      ...
	      return _React2['default'].createElement('th', { className: this.cx({ element: 'WeekdayHeading' }), key: weekday, scope: 'col' }, _React2['default'].createElement('abbr', { title: weekday[0] }, weekday[1]));
	    }).bind(this));

	    return _React2['default'].createElement('tr', { className: this.cx({ element: 'Weekdays' }) }, headers.toJS());
	  },
	  ...
	  renderYearChoice: function renderYearChoice(year) {
	    ...
	    return _React2['default'].createElement('option', { key: year, value: year }, year);
	  },
	  ...
	  renderHeaderYear: function renderHeaderYear() {
	    ...
	    return _React2['default'].createElement('span', { className: this.cx({ element: 'MonthHeaderLabel', modifiers: modifiers }) }, firstOfMonth.format('YYYY'), this.props.disableNavigation ? null : _React2['default'].createElement('select', { className: this.cx({ element: 'MonthHeaderSelect' }), value: y, onChange: this.handleYearChange }, choices.toJS()));
	  },
	  ...
	  renderMonthChoice: function renderMonthChoice(month, i) {
	    ...
	    return _React2['default'].createElement('option', { key: month, value: i, disabled: disabled ? 'disabled' : null }, month);
	  },
	  ...
	  renderHeaderMonth: function renderHeaderMonth() {
	    ...
	    return _React2['default'].createElement('span', { className: this.cx({ element: 'MonthHeaderLabel', modifiers: modifiers }) }, firstOfMonth.format('MMMM'), this.props.disableNavigation ? null : _React2['default'].createElement('select', { className: this.cx({ element: 'MonthHeaderSelect' }), value: firstOfMonth.month(), onChange: this.handleMonthChange }, choices.toJS()));
	  },

	  renderHeader: function renderHeader() {
	    return _React2['default'].createElement('div', { className: this.cx({ element: 'MonthHeader' }) }, this.renderHeaderMonth(), ' ', this.renderHeaderYear());
	  },
	  ...
	  render: function render() {
	    ...
	    return _React2['default'].createElement('div', { className: this.cx({ element: 'Month' }) }, this.renderHeader(), _React2['default'].createElement('table', { className: this.cx({ element: 'MonthDates' }) }, _React2['default'].createElement('thead', null, this.renderDayHeaders()), _React2['default'].createElement('tbody', null, weeks.toJS())));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CalendarDate = _React2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _React2['default'].createElement('td', { className: this.cx({ element: 'Date', modifiers: bemModifiers, states: bemStates }),
	      style: cellStyle,
	      onTouchStart: this.touchStart,
	      onMouseOver: this.mouseOver,
	      onMouseEnter: this.mouseEnter,
	      onMouseLeave: this.mouseLeave,
	      onMouseDown: this.mouseDown }, numStates > 1 && _React2['default'].createElement('div', { className: this.cx({ element: 'HalfDateStates' }) }, _React2['default'].createElement(_CalendarDatePeriod2['default'], { period: 'am', color: amColor }), _React2['default'].createElement(_CalendarDatePeriod2['default'], { period: 'pm', color: pmColor })), numStates === 1 && _React2['default'].createElement('div', { className: this.cx({ element: 'FullDateStates' }), style: style }), _React2['default'].createElement('span', { className: this.cx({ element: 'DateLabel' }) }, date.format('D')), selectionModifier && _React2['default'].createElement(_CalendarSelection2['default'], { modifier: selectionModifier }), highlightModifier && _React2['default'].createElement(_CalendarHighlight2['default'], { modifier: highlightModifier }));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PaginationArrow = _React2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _React2['default'].createElement('div', _extends({ className: this.cx(elementOpts) }, props), _React2['default'].createElement('div', { className: this.cx(iconOpts) }));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactLink = __webpack_require__(39);
	var ReactStateSetters = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCompositeComponent = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(27);
	var ReactTransitionChildMapping = __webpack_require__(66);
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ...
	    if ((/[?&]react_perf\b/).test(url)) {
	      var ReactDefaultPerf = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PooledClass = __webpack_require__(70);
	var CallbackQueue = __webpack_require__(69);
	var ReactPutListenerQueue = __webpack_require__(169);
	var Transaction = __webpack_require__(71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createArrayFrom = __webpack_require__(186);
	var getMarkupWrap = __webpack_require__(185);
	var invariant = __webpack_require__(72);
